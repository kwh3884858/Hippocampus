			...
			try {
				if (Application.platform == RuntimePlatform.Android) {
					...
					if (!File.Exists (connectionString)) {
						WWW load = new WWW ("jar:file://" + Application.dataPath + "!/assets/" + connectionString);
						while (!load.isDone) { }
					...
					connectionString = AssetsManager.STREAMING_PATH + connectionString;
					//构造数据库连接
				...
				Console.Instance ().Debug (connectionString);
			} catch (Exception e) {
