...
namespace StarPlatinum
{
    public class SoundService : Singleton<SoundService>
    {
        ...
        {
            StarPlatinum.EventManager.EventManager.Instance.AddEventListener<PlayerPreSaveArchiveEvent>(OnPlayerPreSaveArchive);
            StarPlatinum.EventManager.EventManager.Instance.AddEventListener<PlayerLoadArchiveEvent>(OnPlayerLoadArchive);
        }

        public void Shutdown()
        {
            StarPlatinum.EventManager.EventManager.Instance.RemoveEventListener<PlayerPreSaveArchiveEvent>(OnPlayerPreSaveArchive);
            StarPlatinum.EventManager.EventManager.Instance.RemoveEventListener<PlayerLoadArchiveEvent>(OnPlayerLoadArchive);
        }
