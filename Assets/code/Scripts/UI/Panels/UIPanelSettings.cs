...
namespace UI.Panels
{
    ...
    public static class UIPanelSettingProvider
    {
        ...
        {
            new UIPanelSettings(UIPanelType.JoystickPanel,UIPanelUnLoadMode.Destroy,false,UIPanelLayer.Layer2,true),
        ...
        public static List<UIPanelSettings> StaticBoardInfo = new List<UIPanelSettings>()
        {
            ...
            new UIPanelSettings(UIPanelType.UICommonMaskPanel,UIPanelUnLoadMode.Destroy,false,UIPanelLayer.Layer9,false),
        };
