...
public class ViewOffset : MonoBehaviour {
   ...
   // public float tileSizeZ;
    ...
    void Update()
    {
        ...
        render.material.SetFloat("_HorizontalDistance", (m_camera.transform.position.x- startPosition.x) / 70);
        render.material.SetFloat("_VerticalDistance", (m_camera.transform.position.y - startPosition.y) / 70);
